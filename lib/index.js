...
var NullType = /** @class */ (function (_super) {
    ...
    function NullType() {
        var _this = _super.call(this, 'null', isNull, function (m, c) { return (isNull(m) ? exports.success(m) : exports.failure(m, c)); }, exports.identity) || this;
        _this._tag = 'NullType';
        return _this;
    }
    return NullType;
...
var UndefinedType = /** @class */ (function (_super) {
    ...
    function UndefinedType() {
        var _this = _super.call(this, 'undefined', isUndefined, function (m, c) { return (isUndefined(m) ? exports.success(m) : exports.failure(m, c)); }, exports.identity) || this;
...
var StringType = /** @class */ (function (_super) {
    ...
    function StringType() {
        var _this = _super.call(this, 'string', isString, function (m, c) { return (isString(m) ? exports.success(m) : exports.failure(m, c)); }, exports.identity) || this;
...
var NumberType = /** @class */ (function (_super) {
    ...
    function NumberType() {
        var _this = _super.call(this, 'number', isNumber, function (m, c) { return (isNumber(m) ? exports.success(m) : exports.failure(m, c)); }, exports.identity) || this;
...
var BooleanType = /** @class */ (function (_super) {
    ...
    function BooleanType() {
        var _this = _super.call(this, 'boolean', isBoolean, function (m, c) { return (isBoolean(m) ? exports.success(m) : exports.failure(m, c)); }, exports.identity) || this;
...
var FunctionType = /** @class */ (function (_super) {
    ...
    function FunctionType() {
        var _this = _super.call(this, 'Function', isFunction, function (m, c) { return (isFunction(m) ? exports.success(m) : exports.failure(m, c)); }, exports.identity) || this;
...
exports.dictionary = function (domain, codomain, name) {
    ...
    return new DictionaryType(name, function (m) {
        return D.is(m) && Object.keys(m).every(function (k) { return domain.is(k) && codomain.is(m[k]); });
    }, function (m, c) {
...
exports.union = function (types, name) {
    ...
    if (index) {
        ...
        }).join(' | '), isTagValue_1, function (m, c) { return (isTagValue_1(m) ? exports.success(m) : exports.failure(m, c)); }, exports.identity);
        ...
        return new UnionType(name, function (m) { return types.some(function (type) { return type.is(m); }); }, function (m, c) {
            ...
            for (var i = 0; i < len; i++) {
                var type_4 = types[i];
                var validation = type_4.validate(m, exports.appendContext(c, String(i), type_4));
