...
var Codec = /** @class */ (function () {
    ...
    Codec.prototype.decode = function (i) {
        return this.validate(i, exports.getDefaultContext(this));
    };
    Codec.prototype.pipe = function (ab, name) {
        var _this = this;
        if (name === void 0) { name = "pipe(" + this.name + ", " + ab.name + ")"; }
        return new Codec(name, ab.is, function (i, c) {
    ...
    Codec.prototype.asEncoder = function () {
        return this;
    };
    return Codec;
}());
...
var undefinedCodec = new UndefinedType();
exports.undefined = undefinedCodec;
/**
 * @since 1.2.0
 * @deprecated
 */
var VoidType = /** @class */ (function (_super) {
    ...
    function VoidType() {
        var _this = _super.call(this, 'void', undefinedCodec.is, undefinedCodec.validate, exports.identity) || this;
        _this._tag = 'VoidType';
        return _this;
    }
    return VoidType;
...
var AnyArrayType = /** @class */ (function (_super) {
    ...
    function AnyArrayType() {
        var _this = _super.call(this, 'UnknownArray', Array.isArray, function (u, c) { return (Array.isArray(u) ? exports.success(u) : exports.failure(u, c)); }, exports.identity) || this;
...
var AnyDictionaryType = /** @class */ (function (_super) {
    ...
    function AnyDictionaryType() {
        var _this = _super.call(this, 'UnknownRecord', isDictionary, function (u, c) { return (isDictionary(u) ? exports.success(u) : exports.failure(u, c)); }, exports.identity) || this;
...
exports.partial = function (props, name) {
    ...
    var partials = {};
    for (var i = 0; i < len; i++) {
        partials[keys[i]] = exports.union([types[i], undefinedCodec]);
    }
...
exports.isIntersectionCodec = function (codec) {
    return codec._tag === 'IntersectionType';
};
exports.isUnionCodec = function (codec) { return codec._tag === 'UnionType'; };
exports.isExactCodec = function (codec) { return codec._tag === 'ExactType'; };
/**
 * @internal
 */
exports.getTypeIndex = function (codec, override) {
    ...
    else if (exports.isIntersectionCodec(codec)) {
        var types = codec.types;
        r = exports.getTypeIndex(types[0], codec);
        for (var i = 1; i < types.length; i++) {
            var ti = exports.getTypeIndex(types[i], codec);
            for (var k in ti) {
    ...
    else if (exports.isUnionCodec(codec)) {
        return exports.getIndex(codec.types);
    }
    else if (exports.isExactCodec(codec)) {
        return exports.getTypeIndex(codec.type, codec);
    }
    return r;
};
var isIndexableCodec = function (codec) {
    return (isInterfaceCodec(codec) ||
        exports.isExactCodec(codec) ||
        exports.isIntersectionCodec(codec) ||
        exports.isUnionCodec(codec) ||
        isStrictCodec(codec));
};
/**
 * @internal
...
exports.union = function (types, name) {
    ...
    if (index) {
        ...
        var TagValue_1 = new Codec(pairs_1.map(function (_a) {
            var v = _a[0];
...
exports.isTagged = function (tag) {
    var f = function (codec) {
        ...
        else if (isRefinementCodec(codec) || exports.isExactCodec(codec)) {
            return f(codec.type);
        }
        else {
            return false;
...
exports.taggedUnion = function (tag, types, name) {
    ...
    var TagValue = new Codec(values.map(function (l) { return JSON.stringify(l); }).join(' | '), isTagValue, function (u, c) { return (isTagValue(u) ? exports.success(u) : exports.failure(u, c)); }, exports.identity);
